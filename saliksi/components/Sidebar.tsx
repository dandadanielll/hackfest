  ...
  return (
    <>
      ...
      <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
        ...
        <NavItem href="/defenders" icon={<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path></svg>} label="Thesis Defenders" active={pathname === '/defenders'} isCollapsed={isCollapsed} />
      </nav>

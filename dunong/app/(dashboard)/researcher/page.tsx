...
export default function ResearcherPage() {
  ...
  const handleSearch = (e: React.FormEvent) => {
    ...
    // Simulate agent loading delay then show results
    setTimeout(() => {
        setResultsMode(true);
    }, 4000); // reduced delay for demo purposes
  };
            ...
            >
                ...
                <div className="space-y-4">
                  <ArticleCard 
                     ...
                     year="2022"
                     credibility={94}
                     abstract="This study investigates the long-term cognitive impacts of early childhood stunting in rural Mindanao communities, providing critical localized data on educational attainment..."
                     localSource={true}
                  />
                  <ArticleCard 
                     ...
                     year="2021"
                     credibility={88}
                     abstract="Analyzing DepEd achievement tests alongside regional health data, this paper identifies significant correlations between malnutrition and mathematics proficiency..."
                     localSource={true}
                  />
                  <ArticleCard 
        ...
        {isSearching && (
          ...
          >
             ...
             <div className="flex-1 overflow-y-auto w-full p-6">
                <AgentThinking 
                   logs={[
                     "Analyzed query: 'malnutrition academic performance philippines'",
                     "Generated Sub-queries: ['stunting cognitive development deped', 'urban-rural nutrition achievement test region vii']",
                     "Filtering to strictly local databases: HERDIN, PHILJOL",
                     "Fetching from HERDIN endpoints...",
                     "Retrieved 12 papers. Checking credibility metrics...",
                     "Discarded 7 low-quality or non-peer-reviewed results.",
                     "Ranked top 5 results by relevance to Philippine context.",
